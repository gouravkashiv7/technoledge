      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {audiences.map((a) => (
            <div
              key={a.title}
              className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-700 text-center hover:shadow-xl transition-shadow relative overflow-hidden group"
            >
              <div
              ...
              <div className="w-32 h-32 mx-auto mb-6 relative">
                <div
                  className={`w-full h-full ${a.bgColor} rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform`}
                >
                  <span
