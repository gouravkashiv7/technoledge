              ...
              {event.side === "left" ? (
                <>
                  <div className="w-full md:w-1/2 text-right md:pr-12 order-2 md:order-1">
                    ...
                    <div
                      className={`glass-card p-6 rounded-2xl inline-block text-left hover:scale-105 transition-transform duration-300 border-l-4 border-l-[#00d2aa]`}
                    >
                ...
                <>
                  ...
                  <div className="w-full md:w-1/2 order-1 md:order-2 md:pl-12">
                    ...
                    <div
                      className={`glass-card p-6 rounded-2xl inline-block text-left hover:scale-105 transition-transform duration-300 border-r-4 border-r-[#00d2aa]`}
                    >
                      <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-2">
                        {event.title}
                      </h4>
