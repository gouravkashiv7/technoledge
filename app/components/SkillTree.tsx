    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-900/50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="relative h-[600px] w-full max-w-5xl mx-auto">
          ...
          {/* AI & ML branch */}
          <div className="absolute bottom-1/3 left-1/2 w-64 h-64 -translate-x-full -translate-y-12 group cursor-pointer">
          ...
          <div className="absolute bottom-1/2 left-1/2 w-48 h-48 translate-x-0 -translate-y-8 group cursor-pointer">
          ...
          {/* Robotics branch */}
          <div className="absolute top-20 left-1/2 w-40 h-40 -translate-x-full group cursor-pointer">
