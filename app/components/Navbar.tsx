...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed inset-x-0 z-50 top-0 glass-panel bg-white/70 dark:bg-surface-alt/70 border-b border-white/20 dark:border-slate-700/30"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-linear-to-br from-accent to-accent-dark flex items-center justify-center shadow-glow">
