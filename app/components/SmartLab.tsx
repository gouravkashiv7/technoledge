  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0f172a] relative" id="labs">
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
        {/* Server rack visual */}
        <div className="order-2 lg:order-1 relative h-[600px] perspective-1000 group">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-8">
            ...
            high-performance computing clusters to IoT sensor arrays, we provide
            the physical backbone for digital innovation. The interactive rack
            demonstrates our modular server architecture designed for
            scalability.
          </p>
