        ...
        <div className="w-full md:w-1/2 perspective-1000">
          <div className="glass-card p-8 rounded-3xl shadow-2xl animate-float border-t border-l border-white/50 relative">
            ...
            <form className="space-y-6">
              ...
              <button
                className="w-full py-4 bg-gradient-to-r from-[#00d2aa] to-emerald-600 text-white font-bold rounded-xl shadow-glow transform hover:scale-[1.02] transition-transform"
                type="button"
              >
                Send Message
              </button>
